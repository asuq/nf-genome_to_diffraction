...
def _scientist_node_details(stages: list[dict[str, Any]]) -> str:
    ...
    first_component = {
        "title": "One-copy A screen and review",
        ...
        "maturity": by_id["rank-mr"]["maturity"],
        "warning": "Initial tasks search one copy; expected copies remain priors and additional copies require explicit A approval.",
    }
