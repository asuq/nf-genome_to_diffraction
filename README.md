...
[![CI: dev/phase3](https://github.com/asuq/nf-genome_to_diffraction/actions/workflows/ci.yml/badge.svg?branch=dev%2Fphase3)](https://github.com/asuq/nf-genome_to_diffraction/actions/workflows/ci.yml?query=branch%3Adev%2Fphase3)
...
> supports the bounded two-component form `ASU = nA + mB`. The `dev/phase3`
> branch contains unreleased general-composition work and may change before
> `v0.3.0`.
