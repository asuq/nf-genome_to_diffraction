...
review package.  It does not prove run ownership or package membership; the future
staging boundary must verify those facts before consuming a decision.

Inputs and outputs
------------------
``PhaseIIIReviewDecision`` contains the crystal/item target, decision, reviewer,
UTC-normalised review time, reason, and optional comment.  One
...
from a byte checksum of the source TSV; future staging must retain and verify that
