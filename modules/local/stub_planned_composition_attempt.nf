...
// parent/candidate model resolutions, diffraction selection, Free-R identity,
// all-model-registry identity, opaque global execution identity, and the
// complete validated inventory file.
//
...
process STUB_PLANNED_COMPOSITION_ATTEMPT {
    ...
    """
    mkdir -p '${outputName}'
    cp '${item[10]}' '${outputName}/composition_attempt_inventory.json'
    printf '%s\n' \
