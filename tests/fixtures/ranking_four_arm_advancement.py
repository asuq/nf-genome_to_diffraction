...
_SOURCE_PATHS = (
    ...
    "tests/fixtures/ranking_four_arm_context.py",
    "tests/fixtures/ranking_four_arm_cli.py",
    "tests/fixtures/ranking_four_arm_aggregate.py",
    "rf_reference.nf",
    "tests/fixtures/ranking_four_arm_tasks.nf",
    "tests/fixtures/ranking_four_arm_workflow.nf",
    "tests/fixtures/ranking_four_arm_stub.py",
    "tests/fixtures/ranking_four_arm_execution.py",
    "tests/fixtures/ranking_four_arm_native.py",
    "tests/fixtures/ranking_four_arm_native_discovery.py",
    "src/genome_to_diffraction/hpc/rf_reference_evidence.py",
    "src/genome_to_diffraction/hpc/login_process.py",
    "src/genome_to_diffraction/execution_evidence.py",
    "src/genome_to_diffraction/phenix/runtime.py",
    "bootstrap/nf-gtd-hpc-remote",
    "bootstrap/nf-gtd-hpc-smoke-job",
    "conf/base.config",
    "conf/raven.config",
    "benchmarks/m6/execution-nextflow-raven-v2.yaml",
    "src/genome_to_diffraction/benchmarks/m6_execution.py",
